...
const stats = [
  { value: "12+", label: "Projets réalisés", icon: Rocket },
  { value: "8+", label: "Clients satisfaits", icon: UsersRound },
  { value: "3", label: "Pays d’intervention", icon: AfricaIcon },
];

export function HeroProjects() {
  return (
    <section className="mx-auto grid max-w-[1200px] items-center gap-12 px-5 pb-14 pt-12 md:pt-16 lg:grid-cols-[0.94fr_1.06fr] lg:gap-16 lg:px-8 lg:pb-16 lg:pt-14">
      ...
      <div className="relative mx-auto w-full max-w-[590px] px-7 py-5 sm:px-12 sm:py-8">
        ...
        <div className="relative aspect-[1.22/1] overflow-hidden rounded-[56px_24px_56px_24px] bg-brand-sky-soft">
          <img
            src={heroImage}
            alt="Professionnelle africaine travaillant sur un ordinateur portable"
            width={1024}
            height={768}
        ...
        <div className="absolute right-1 top-[12%] grid grid-cols-[1fr_auto] items-center gap-2 rounded-[18px_5px_18px_5px] bg-background px-4 py-3 shadow-float sm:right-2">
          <p className="text-[11px] font-semibold leading-[1.25] text-foreground sm:text-xs">Des idées<br />qui transforment<br />l’Afrique</p>
